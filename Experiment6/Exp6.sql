...
PRIMARY 
KEY, 
product_name VARCHAR(100), price 
NUMERIC(10,2), 
...
quantity INT, total_price NUMERIC(10,2), 
sale_date TIMESTAMP DEFAULT NOW() 
); 
CREATE OR REPLACE PROCEDURE 
place_order( IN p_product_id INT, IN 
p_quantity INT ) 
LANGUAGE plpgsql 
AS $$ 
DECLARE 
